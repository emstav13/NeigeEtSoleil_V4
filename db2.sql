...
INSERT INTO `activite_sportive` VALUES (4,'Ski alpin','avancé'),(5,'Ski hors-piste','intermédiaire'),(9,'Randonnée nocturne','débutant'),(10,'Snowboard freestyle','avancé');
...
INSERT INTO `proprietaire` VALUES (1,2,NULL),(2,3,'[1, 3, 5, 7, 9]'),(3,8,'[2, 4, 6, 8, 10, 13]');
...
INSERT INTO `reservation` VALUES (1,4,1,'2025-02-13','2025-02-15','confirmé'),(2,4,8,'2025-02-17','2025-02-20','confirmé'),(3,4,8,'2025-02-17','2025-02-20','reserve'),(4,4,8,'2025-02-17','2025-02-20','reserve');
...
--
-- Temporary view structure for view `reservations_confirmees`
--

DROP TABLE IF EXISTS `reservations_confirmees`;
/*!50001 DROP VIEW IF EXISTS `reservations_confirmees`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `reservations_confirmees` AS SELECT 
 1 AS `id_reservation`,
 1 AS `nom_client`,
 1 AS `prenom_client`,
 1 AS `email_client`,
...
--
-- Temporary view structure for view `reservations_en_attente`
--

DROP TABLE IF EXISTS `reservations_en_attente`;
/*!50001 DROP VIEW IF EXISTS `reservations_en_attente`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `reservations_en_attente` AS SELECT 
 1 AS `id_reservation`,
 1 AS `nom_client`,
 1 AS `prenom_client`,
 1 AS `email_client`,
...
INSERT INTO `tarif` VALUES (5,13,NULL,1,200.00),(6,NULL,1,1,20.00),(7,NULL,2,1,20.00),(8,NULL,3,1,15.50),(9,NULL,4,1,35.00),(10,NULL,5,2,25.00),(11,NULL,6,3,30.00),(12,NULL,7,2,12.00),(13,NULL,8,2,18.00),(14,NULL,9,3,22.00),(15,NULL,10,3,14.00),(20,1,NULL,3,240.00),(21,1,NULL,2,300.00),(22,1,NULL,1,360.00),(23,2,NULL,3,260.00),(24,2,NULL,2,325.00),(25,2,NULL,1,390.00),(26,3,NULL,3,280.00),(27,3,NULL,2,350.00),(28,3,NULL,1,420.00),(29,4,NULL,3,220.00),(30,4,NULL,2,275.00),(31,4,NULL,1,330.00),(32,5,NULL,3,190.00),(33,5,NULL,2,237.50),(34,5,NULL,1,285.00),(35,6,NULL,3,300.00),(36,6,NULL,2,375.00),(37,6,NULL,1,450.00),(38,7,NULL,3,320.00),(39,7,NULL,2,400.00),(40,7,NULL,1,480.00),(41,8,NULL,3,250.00),(42,8,NULL,2,312.50),(43,8,NULL,1,375.00),(44,9,NULL,3,280.00),(45,9,NULL,2,350.00),(46,9,NULL,1,420.00),(47,10,NULL,3,340.00),(48,10,NULL,2,425.00),(49,10,NULL,1,510.00),(50,13,NULL,3,88.00),(51,13,NULL,2,110.00),(52,13,NULL,1,132.00);
...
INSERT INTO `utilisateur` VALUES (1,'Dupont','Jean','jean.dupont@example.com','motdepasse123','client','2025-01-21 14:39:21'),(2,'test','test','test@example.com','test123','proprietaire','2025-01-21 17:26:57'),(3,'test','qtr','qtr@gmail.com','0000','proprietaire','2025-01-21 18:07:59'),(4,'test','cnq','t5@gmail.fr','0000','client','2025-01-21 21:36:27'),(6,'Touinsi','Nabil','n@gmail.com','0000','admin','2025-02-02 00:30:30'),(7,'Dudont','Jean','jean.dupont@example.tn','$2b$10$6PgAcWJAidUNar5ZZsdiXOyI0EPyzI/U0YaWPC6lApvg/FhwW4WMm','client','2025-02-04 15:23:43'),(8,'aa','zz','az@hotmail.fr','$2b$10$CX3Fd8v2i1/c6dSl4wzhsu6KRW2yuQx57Ec4QxdtiAvDPdi5rNe1G','proprietaire','2025-02-04 15:28:53');
...
--
-- Final view structure for view `reservations_confirmees`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `reservations_confirmees` AS select `r`.`id_reservation` AS `id_reservation`,`u`.`nom` AS `nom_client`,`u`.`prenom` AS `prenom_client`,`u`.`email` AS `email_client`,`l`.`nom_immeuble` AS `logement`,`l`.`adresse` AS `adresse`,`r`.`date_debut` AS `date_debut`,`r`.`date_fin` AS `date_fin`,`r`.`statut` AS `statut` from ((`reservation` `r` join `utilisateur` `u` on((`r`.`id_utilisateur` = `u`.`id_utilisateur`))) join `logement` `l` on((`r`.`id_logement` = `l`.`id_logement`))) where (`r`.`statut` = 'confirmé') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `reservations_en_attente`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `reservations_en_attente` AS select `r`.`id_reservation` AS `id_reservation`,`u`.`nom` AS `nom_client`,`u`.`prenom` AS `prenom_client`,`u`.`email` AS `email_client`,`l`.`nom_immeuble` AS `logement`,`l`.`adresse` AS `adresse`,`r`.`date_debut` AS `date_debut`,`r`.`date_fin` AS `date_fin`,`r`.`statut` AS `statut` from ((`reservation` `r` join `utilisateur` `u` on((`r`.`id_utilisateur` = `u`.`id_utilisateur`))) join `logement` `l` on((`r`.`id_logement` = `l`.`id_logement`))) where (`r`.`statut` = 'reserve') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-02-08 12:25:34
