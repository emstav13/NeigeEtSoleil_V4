...
public class PanelProfil extends PanelPrincipal implements ActionListener {
	...
	public PanelProfil() {
		...
		this.txtInfos.setBorder(BorderFactory.createCompoundBorder(new LineBorder(Color.LIGHT_GRAY, 2),
	...
	private void majInfosProfil() {
		this.txtInfos.setText("________________ INFOS PROFIL UTILISATEUR _____________\n\n" + " Nom : "
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.btModifier) {
			...
			if (Controleur.verifDonnees(lesChamps) && mdp1.equals(mdp2)) {
				...
				JOptionPane.showMessageDialog(this, "Modification des données réussie", "Modification",
						JOptionPane.INFORMATION_MESSAGE);

				majInfosProfil();
			} else {
				JOptionPane.showMessageDialog(this, "Veuillez remplir les champs correctement.", "Modification Profil",
