...
public class Logement {
	...
	public Logement(int idLogement, int idProprietaire, String nomImmeuble, String adresse, String codePostal,
			String ville, String typeLogement, float surfaceHabitable, int capaciteAccueil, String specifite,
			String photo) {
